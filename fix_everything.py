...
start_split = "    def handle_command(self, cmd_text: str, chat_id: str):"
end_split = "elif cmd_text.startswith(\"/takeprofit\"):"

parts1 = content.split(start_split)
parts2 = parts1[1].split(end_split)
...
final_content = parts1[0] + start_split + new_block + end_split + parts2[1]
